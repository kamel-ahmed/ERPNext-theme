...
const hideSidebar = async () => {
    ...
    toggle_button.addEventListener("click", () => {
        ...
        if (!sidebar_status) {
            ...
            get_sidebar_items();
            toggle_button.innerHTML = frappe.utils.icon("sidebar-collapse" || "home", "sm");
            toggle_button.style.marginLeft = "100px"
            document.querySelector("#side-menu-component").style.display = "block"
            document.querySelector("#side-menu-perent").style.minWidth = "100px"
        }
...
const get_sidebar_items = async () => {
    try {
        ...
        // const system_sidebar = theme_setting_doc?.default_sidebar || 0;
        ...
        sidebar_items.forEach(item => {
            ...
            // custom Icons
            const custom_icons = theme_setting_doc?.side_icons || [];
            ...
            if (showLabel == 1) {
                ...
                title.textContent = (item.title).length > 8 ? (item.title).substring(0, 6) + "..." : item.title;
...
const hideSubSidebar = async () => {
    ...
    const sub_menu_toggle_fun = () => {
        if (sub_sidebar_status) {
            ...
            sub_toggle_button.style.marginLeft = "230px"
            document.querySelector("#sub-menu").style.minWidth = "230px"
